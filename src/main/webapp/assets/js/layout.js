        ...
        ((t = document.documentElement.attributes),
            ...
            sessionStorage.getItem("defaultAttribute") !== JSON.stringify(a)
                ...
                : (((e = {})["data-layout"] = sessionStorage.getItem("data-layout")),
                    ...
                    (e["defaultAttribute"] = { "lang": "en", "data-layout": "vertical", "data-topbar": "light", "data-sidebar": "dark", "data-sidebar-size": "lg", "data-sidebar-image": "none", "data-preloader": "disable" }),
